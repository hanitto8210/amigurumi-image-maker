...
/*            { name: "ボディ-MW", src: "images/Rbody_mw.webp" }, *//*デフォルトなので選択肢から除外*/
        ...
        clothes: [
            ...
            { name: "cos_c_ribb_li", src: "images/cos_c_ribb_li.webp", icon: "images/icons/cos_c_ribb_li.webp" },
            { name: "cos_c_ribb_ibl", src: "images/cos_c_ribb_ibl.webp", icon: "images/icons/cos_c_ribb_ibl.webp" },
            { name: "cos_c_ribb_ab", src: "images/cos_c_ribb_ab.webp", icon: "images/icons/cos_c_ribb_ab.webp" },
            { name: "cos_c_ribb_bl", src: "images/cos_c_ribb_bl.webp", icon: "images/icons/cos_c_ribb_bl.webp" },
            { name: "cos_c_ribb_mt", src: "images/cos_c_ribb_mt.webp", icon: "images/icons/cos_c_ribb_mt.webp" },
            { name: "cos_c_ribb_br", src: "images/cos_c_ribb_br.webp", icon: "images/icons/cos_c_ribb_br.webp" },
            { name: "cos_c_ribb_bk", src: "images/cos_c_ribb_bk.webp", icon: "images/icons/cos_c_ribb_bk.webp" },
            { name: "cos_c_ribb_mw", src: "images/cos_c_ribb_mw.webp", icon: "images/icons/cos_c_ribb_mw.webp" },
            { name: "cos_c_ribb_w", src: "images/cos_c_ribb_w.webp", icon: "images/icons/cos_c_ribb_w.webp" },
